...
define('GA_SPAN1', 'span1');
define('GA_SPAN2', 'span2');
define('GA_SPAN3', 'span3');
define('GA_SPAN4', 'span4');
define('GA_SPAN5', 'span5');
define('GA_SPAN6', 'span6');
define('GA_SPAN7', 'span7');
define('GA_SPAN8', 'span8');
define('GA_SPAN9', 'span9');
define('GA_SPAN10', 'span10');
define('GA_SPAN11', 'span11');
define('GA_SPAN12', 'span12');
...
/**
 * Constants for formatting Bootstrap elements
 */
...
/**
 * Constants to define size of bootstrap element.
 */
define('GA_XS' , 'mini');
define('GA_S' , 'small');
define('GA_L' , 'large');
